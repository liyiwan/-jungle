...
public class TaobaoApiManagerImpl implements TaobaoApiManager {
	...
	public Trade getTaobaoTrade(Long tid, String appkey, String appsecret, String sessionkey) {
		...
		req.setFields("tid,seller_nick,buyer_nick,title,type,created,seller_rate,buyer_rate,status,payment,discount_fee,has_post_fee,adjust_fee,post_fee,total_fee,pay_time,end_time,modified,consign_time,buyer_obtain_point_fee,point_fee,real_point_fee,received_payment,commission_fee,buyer_memo,seller_memo,alipay_no,buyer_message,pic_path,num_iid,num,price,cod_fee,cod_status,shipping_type,orders,receiver_address,receiver_name,receiver_mobile,receiver_phone,receiver_state,receiver_city,receiver_district,buyer_alipay_no,receiver_zip,buyer_email");
    	req.setTid(tid);
